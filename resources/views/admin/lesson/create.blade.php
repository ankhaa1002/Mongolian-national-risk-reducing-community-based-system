    ...
    <div class="span12">
        <div class="portlet box blue">
            ...
            <div class="portlet-body form">
                <!-- BEGIN FORM-->
                <form id="addLessonForm" action="{{ route('admin.lesson.store') }}" method="POST" class="horizontal-form" enctype="multipart/form-data">
                    ...
                    <div class="row-fluid">
                        ...
                        <div class="span6 ">
                            <div class="control-group">
                                <label class="control-label" for="teacher">Багш<span class="required">*</span></label>
                                <div class="controls">
                                    <select id="teacher" name="teacher" class="m-wrap span12" required>
                                        <option></option>
...
//            success1.show();
    ...
    function backToList() {
        window.location.replace("{{route('admin.lesson.index')}}");
    }
