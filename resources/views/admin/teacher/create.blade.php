...
<div class="row-fluid">
    <div class="span12">
        ...
        <form action="{{ route('admin.teacher.store') }}" method="POST" id="createTeacher" data-toggle="validator" role="form" enctype="multipart/form-data">
                ...
                <div class="tab-content">
                            ...
                            <div class="row-fluid">
                                <div class="span4">
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            <input id="lastname" maxlength="255" name="lastname" type="text" class="m-wrap span12" placeholder="Овог" required>
                                        </div>
                                    </div>
                                </div>
                                <div class="span4">
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            <input id="firstname" maxlength="255" name="firstname" type="text" class="m-wrap span12" placeholder="Нэр" required>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="row-fluid">
                                <div class="span4">
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            <input id="birthdate" pattern="^[0-9]{4}-[0-1][0-9]-[0-3][0-9]$" name="birthdate" type="text" class="m-wrap span12" placeholder="Төрсөн огноо" required>
                                        </div>
                                    </div>
                                </div>
                                <div class="span4">
                            ...
                            <div class="row-fluid">
                                <div class="span4">
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            <input id="profession" name="profession" maxlength="255" type="text" class="m-wrap span12" placeholder="Мэргэжил" required>
                                        </div>
                                    </div>
                                </div>
                                <div class="span4">
                            ...
                            <div class="row-fluid">
                                <div class="span4">
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            <input id="position" name="position" maxlength="255" type="text" class="m-wrap span12" placeholder="Албан тушаал" required>
                                        </div>
                                    </div>
                                </div>
                                <div class="span4">
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            <input type="email" id="email" name="email" type="text" class="m-wrap span12" placeholder="Цахим хаяг" required>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="row-fluid">
                                <div class="span4">
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            <input id="phone1" name="phone1" type="text" class="m-wrap span12" placeholder="Утас 1" required>
                                        </div>
                                    </div>
                                </div>
                                <div class="span4">
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            <input id="phone2" name="phone2" type="text" class="m-wrap span12" placeholder="Утас 2">
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row-fluid">
                                <div class="span8">
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            <input id="address" name="address" type="text" class="m-wrap span12" placeholder="Дэлгэрэнгүй хаяг">
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div id="tab_3-3" class="tab-pane">
                        <div style="height: auto;" id="accordion3-3" class="accordion collapse in">
                            ...
                            <input id="username" name="username" placeholder="Нэвтрэх нэр" type="text" class="m-wrap span8" required>
                            <label for="password" class="control-label">Нууц үг<span class="required">*</span></label>
                            <input id="password" name="password" placeholder="Нууц үг" type="password" class="m-wrap span8" required>
                            <label for="password2" class="control-label">Нууц үг /давт/<span class="required">*</span></label>
                            <input id="password2" type="password" placeholder="Нууц үг /давт/" name="password_again" class="m-wrap span8" required>
                        </div>
                    </div>

                </div>
                <div class="submit-btn">
                    <button type="submit" href="#" class="btn green">Хадгалах</button>
...
<script type="text/javascript">
    ...
    $('#createTeacher').on('submit', function () {
