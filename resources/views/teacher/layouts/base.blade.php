                    ...
                    <ul class="nav pull-right">
                        ...
                        <li class="dropdown user">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                                @if(Session::get('avatar')->portrait_image != null)
                                <img width="29" height="29" alt="" src="{{ asset(Session::get('avatar')->portrait_image) }}" />
                                @else
                                <img width="29" height="29" src="http://www.placehold.it/200x150/EFEFEF/AAAAAA&amp;text=no+image" />
                                @endif
