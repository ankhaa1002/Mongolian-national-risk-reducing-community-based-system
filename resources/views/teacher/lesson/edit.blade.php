    ...
    <div class="span12">
        <div class="portlet box blue">
            ...
            <div class="portlet-body form">
                <!-- BEGIN FORM-->
                {!! Form::model($lesson,array('method'=>'PATCH','route'=>array('adminTeacher.lesson.update',$lesson->id),'files' => true,'id'=>'editLessonForm')) !!}
                ...
                <div class="row-fluid">
                    <div class="span12 ">
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <input type="text" name="title" value="{{ $lesson->lesson_name }}" id="title" class="m-wrap span12" placeholder="" required="">
                            </div>
                        </div>
                    </div>
                    <!--/span-->
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <select id="categories" name="category" class="m-wrap span12" required>
                                    ...
                                    <option @if($lesson->lesson_category_id == $cat['id']) selected @endif value="{{$cat['id']}}">{{$cat['name']}}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <select id="channels" name="channel" class="m-wrap span12" required>
                                    ...
                                    <option @if($lesson->lesson_channel_id == $channel['id']) selected @endif value="{{$channel['id']}}">{{$channel['name']}}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                                ...
                                <div class="fileupload fileupload-new" data-provides="fileupload">
                                    <div class="input-append">
                                        <div class="uneditable-input">
                                            ...
                                            <span class="fileupload-preview">{{ $lesson->ppt_url }}</span>
                                        </div>
                            ...
                            <div class="controls">
                                <div class="fileupload fileupload-new" data-provides="fileupload">
                                    <div class="input-append">
                                        <div class="uneditable-input">
                                            <i class="icon-file fileupload-exists"></i> 
                                            <span class="fileupload-preview">{{ $lesson->video_url }}</span>
                                        </div>
                                        <span class="btn btn-file">
                                            <span class="fileupload-new">Файл сонгох</span>
                                            <span class="fileupload-exists">Өөрчлөх</span>
